...
public class CarroMain {
	...
	public static void main(String[] args) {
		...
		Carro carro2 = new Carro("Pálio", "Fiat", "prata", 4, false, false, false, false, 35000, true);
		Carro carro3 = new Carro("Civic", "Honda", "branca", 4, true, true, true, true, 110000, true);
		Carro carro4 = new Carro("Corolla", "Toyota", "preto", 4, true, true, false, true, 110000, true);
